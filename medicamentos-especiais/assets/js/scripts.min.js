...
var getIdentificacao=document.getElementById("identificacao"),inputPaciente=document.querySelector(".form-paciente");getIdentificacao.addEventListener("change",function(e){"Paciente"!=getIdentificacao.value?inputPaciente.classList.add("form-paciente-show"):inputPaciente.classList.remove("form-paciente-show")});