...
readyListRedirect:function(){if(!(-1<(location.search||"").indexOf("lid="))){var a=$(".giftlistinfo-members").clone();a.find("span").remove();var b="lista"==a.find(".surname").text().trim().toLowerCase(),a="drogaria araujo"==a.find(".name").text().trim().toLowerCase(),c="lista pronta"==$(".giftlistinfo-title").text().trim().toLowerCase();b&&a&&c&&(location.href="/giftlist/ready-list")}},hideSearchNavigator:function(){var a=$(".search-single-navigator h5");a.click(function(){$(this).toggleClass("qd-active").next().slideToggle()});
