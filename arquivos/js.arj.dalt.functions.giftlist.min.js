...
List.changeReadyListTitle();Product.insertSkuModalCustomize();List.giftlistReadySetId();List.paginationStartFix();List.hideSearchNavigator();List.addLinkBeforeSidebar();List.readyListRemoveLinks();List.qdMobileListSearchMenu();List.insertLidListLinks();List.giftlistReadySetProductName();List.giftlistCreteRemoveListTypes();List.changeTagHtmlSeachNavigator();-1<location.pathname.toLowerCase().indexOf("/giftlist/product")&&(List.getGiftListBalance(),List.getGiftBalance());List.getGiftListCreateModalOpen()},
ajaxStop:function(){List.readyListRemoveLinks();List.giftlistReadySetProductName();-1<location.pathname.toLowerCase().indexOf("/giftlist/product")&&List.addValueTotalGift()},windowOnload:function(){},changeTagHtmlSeachNavigator:function(){$(".search-single-navigator h3").each(function(){var a=$(this);a.replaceWith("<h1>"+a.html()+"</h1>")})},postRDStation:function(){if(-1<location.pathname.indexOf("/giftlist/create")||-1<location.hash.indexOf("readylist=1")){var a="Clicou no CTA - Criar sua lista";
-1<location.hash.indexOf("readylist=1")&&(a="Clicou no CTA - Listas prontas");$.qdAjax({url:"/no-cache/profileSystem/getProfile",dataType:"json",clearQueueDelay:null,success:function(b){$.getScript("//d335luupugsy2.cloudfront.net/js/integration/stable/rd-js-integration.min.js",function(){RdIntegration.post([{name:"email",value:b.Email},{name:"identificador",value:a},{name:"nome",value:(b.FirstName||b.Email)+" "+(b.LastName||"")},{name:"token_rdstation",value:"19afe9cd6a66d4578bcc6b174a4d186a"}])})}})}},
giftlistCreteRemoveListTypes:function(){$(document.body).is(".giftlist-create")&&Product.removeGiftlistTypes($("#giftlisttype"))},giftlistReadySetProductName:function(){$(document.body).is(".giftlist-shelf-list")&&$(".buy-sku-name").each(function(){var a=$(this);a.closest("li[layout]").find(".shelf-common-product-name a").text(a.text().trim())})},insertLidListLinks:function(){if($(document.body).is(".giftlist-shelf-list")){var a=(location.search.match(/lid=[^&]+/i)||[""]).pop();a.length&&$(".navigation a").each(function(){this.search+=
"&"+a})}},qdMobileListSearchMenu:function(){$(".search-qd-v1-navigator-btn").click(function(){$("body").toggleClass("qd-sam-on")});$(".search-qd-v1-navigator-close").click(function(){$("body").removeClass("qd-sam-on")});$(document.body).on("swipeleft",function(a,b){$(document.body).removeClass("qd-sam-on")})},addLinkBeforeSidebar:function(){var a=$(".giftlistinfo-link input").val(),a=$('<a href="'+a+'"></a>'),b=$('<a class="gf-shelf-back-link" href="'+location.href+'"><i class="fa fa-reply-all"></i> Ver lista completa</a>');
b[0].pathname=a[0].pathname;$(".gf-shelf-navigator").prepend(b);$(".search-qd-v1-navigator-title").after(b)},readyListRedirectAddNoRedirect:function(){$.qdAjax({url:"/no-cache/profileSystem/getProfile",dataType:"json",clearQueueDelay:null,success:function(a){a.IsUserDefined&&$(function(){var a=$(".glmanager-type");a.find("li.action-view a").each(function(){this.search="redirect=false&"+this.search.replace("?","")});a.find("li.action-manage a").each(function(){this.search="redirect=false&"+this.search.replace("?",
"");this.protocol="https:"})})}})},readyListRedirect:function(){var a=location.search||"";if(!(-1<a.indexOf("lid=")||-1<a.indexOf("redirect=false"))){var b=$(".giftlistinfo-members").clone();b.find("span").remove();var a="lista"==b.find(".surname").text().trim().toLowerCase(),b="drogaria araujo"==b.find(".name").text().trim().toLowerCase(),c="lista pronta"==$(".giftlistinfo-title").text().trim().toLowerCase();a&&b&&c&&(location.href="/giftlist/ready-list")}},hideSearchNavigator:function(){var a=$(".search-single-navigator h5");
