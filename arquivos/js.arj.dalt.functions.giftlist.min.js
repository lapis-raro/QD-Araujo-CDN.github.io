...
List.giftlistReadySetId();List.paginationStartFix();List.hideSearchNavigator();List.addLinkBeforeSidebar();List.readyListRemoveLinks();List.qdMobileListSearchMenu();List.insertLidListLinks();-1<location.pathname.toLowerCase().indexOf("/giftlist/product")&&(List.getGiftListBalance(),List.getGiftBalance());List.getGiftListCreateModalOpen()},ajaxStop:function(){List.readyListRemoveLinks();-1<location.pathname.toLowerCase().indexOf("/giftlist/product")&&List.addValueTotalGift()},windowOnload:function(){},
