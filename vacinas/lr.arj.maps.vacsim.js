...
$(document).ready(function() {
	var map,
		locations = [
			...
			[-19.886905, -43.929193, 'Araujo Cristiano Machado – Cidade Nova – Av. Cristiano Machado, 2.400<hr>De segunda a sábado, das 8h às 20h, exceto feriados.'],
			[-19.968386, -43.964553, 'Araujo Estoril – Estoril – Av. Professor Mário Werneck, 1.340<hr>De segunda a sábado, das 8h às 20h, exceto feriados.'],
			[-19.939905, -43.934592, 'Araujo Savassi – Funcionários – Av. do Contorno, 6.115<hr>De segunda a sábado, das 8h às 20h, exceto feriados.'],
			[-19.843573, -43.971408, 'Araujo Portugal – Jardim Atlântico – Av. Portugal, 2.841<hr>De segunda a sábado, das 8h às 20h, exceto feriados.'],
			[-19.949079, -43.920340, 'Araujo Praça da Bandeira – Mangabeiras – Praça da Bandeira, 180<hr>De segunda a sábado, das 8h às 20h, exceto feriados.'],
			[-19.914718, -43.973432, 'Araujo Padre Eustáquio – Padre Eustáquio – Rua Padre Eustáquio, 2.208<hr>Todos os dias, das 8h às 20h, exceto feriados.'],
			[-19.915057, -44.082383, 'Araujo Gil Diniz – Nossa Senhora do Carmo – Av. Prefeito Gil Diniz, 777 - Contagem<hr>Todos os dias, das 8h às 20h, exceto feriados.']
		];
	var myOptions = {
		zoom: 11,
	...
	for (i = 0; i < locations.length; i++) {
		...
		google.maps.event.addListener(infowindow, 'domready', function() {
			...
			iwBackground.children(':nth-child(3)').attr('style', function(i, s) {
				return s + 'background-color:#ed2b33 !important; color:#ed2b33 !important; border-color:#ed2b33 !important'
			});
